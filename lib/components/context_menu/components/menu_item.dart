...
final class MenuItem<T> extends ContextMenuItem<T> {
  ...
  getNormalTextColor(BuildContext context) {
    if(isDisabled) {
      return context.colorScheme.onSurface.withOpacity(0.3);
    }
  ...
  getBackgroundColor(bool isFocused, BuildContext context) {
    if(isDisabled) {
      return context.colorScheme.surface.withOpacity(0.3);
    }
  ...
  getForegroundColor(bool isFocused, BuildContext context) {
    if(isDisabled) {
      return context.colorScheme.onSurface.withOpacity(0.3);
    }
  ...
  Widget builder(BuildContext context, ContextMenuState menuState,
    ...
    final background = getBackgroundColor(isFocused, context);
    final foregroundColor = getForegroundColor(isFocused, context);
    ...
    return ConstrainedBox(
      ...
      child: Material(
        ...
        child: InkWell(
          onTap: isDisabled ? null : () => handleItemSelection(context),
